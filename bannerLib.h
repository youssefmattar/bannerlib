...
//******* prototypes ***********
int printBanner(const char text[]);
...
int printBanner(const char  text[])
{
	...
	p1 = (char*)malloc(sum * sizeof(char));
	p2 = (char*)malloc(sum * sizeof(char));
	p3 = (char*)malloc(sum * sizeof(char));
	p4 = (char*)malloc(sum * sizeof(char));
	p5 = (char*)malloc(sum * sizeof(char));
	p6 = (char*)malloc(sum * sizeof(char));
	p7 = (char*)malloc(sum * sizeof(char));
	p8 = (char*)malloc(sum * sizeof(char));
	//strcpy(buff, text);
